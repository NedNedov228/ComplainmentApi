...
const zayavkiDB = {
    createZayavkiTable: () => createTable('zayavki', 'id INTEGER PRIMARY KEY AUTOINCREMENT, description TEXT, status INTEGER, user_id INTEGER, FOREIGN KEY (user_id) REFERENCES users(id)'),
